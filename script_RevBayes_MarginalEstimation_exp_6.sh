...
Rscript script_write_matrix_v2.R $calls $mod
...
echo "ss = steppingStoneSampler(file=\"output_fuller_$calls/mk_$calls.$mod.ss\", powerColumnName=\"power\", likelihoodColumnName=\"likelihood\")" >> mcmc_primates_tmp.Rev 
